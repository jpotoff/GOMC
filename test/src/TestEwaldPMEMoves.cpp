...
class EwaldPMEMEMC2LiqTest : public ::testing::Test {
protected:
  void SetUp() override {
...
TEST_F(EwaldPMEMEMCTest, MEMC2MoveConsistency) {
  ...
  double recipGainLarge =
      pme->SwapDestRecip(newLargeMol, destBox, largeMolIndex);
  double recipLoseLarge =
      pme->SwapSourceRecip(oldLargeMol, sourceBox, largeMolIndex);

  double recipGainSmall =
      pme->SwapDestRecip(newSmallMol, sourceBox, smallMolIndex);
  double recipLoseSmall =
      pme->SwapSourceRecip(oldSmallMol, destBox, smallMolIndex);
...
TEST_F(EwaldPMEMEMC2LiqTest, MEMC2LiqMoveConsistency) {
