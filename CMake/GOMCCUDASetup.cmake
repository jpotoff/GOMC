...
set(CMAKE_CUDA_COMP_FLAGS ${CMAKE_CUDA_COMP_FLAGS} -DGOMC_CUDA)
...
if(ENSEMBLE_GPU_NVT)
    ...
    target_include_directories(GPU_NVT PRIVATE ${FFTW3_INCLUDE_DIRS})
    target_link_libraries(GPU_NVT ${FFTW3_LIBRARIES})
    if(MPI_FOUND)
...
if(ENSEMBLE_GPU_GEMC)
    ...
    target_include_directories(GPU_GEMC PRIVATE ${FFTW3_INCLUDE_DIRS})
    target_link_libraries(GPU_GEMC ${FFTW3_LIBRARIES})
    if(MPI_FOUND)
...
if(ENSEMBLE_GPU_GCMC)
    ...
    target_include_directories(GPU_GCMC PRIVATE ${FFTW3_INCLUDE_DIRS})
    target_link_libraries(GPU_GCMC ${FFTW3_LIBRARIES})
    if(MPI_FOUND)
...
if(ENSEMBLE_GPU_NPT)
    ...
    target_include_directories(GPU_NPT PRIVATE ${FFTW3_INCLUDE_DIRS})
    target_link_libraries(GPU_NPT ${FFTW3_LIBRARIES})
    if(MPI_FOUND)
